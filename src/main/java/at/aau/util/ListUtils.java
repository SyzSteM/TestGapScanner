...
/**
 * Provides utility methods for operations on {@code List} objects. This class includes methods to
 * check non-null or non-empty states of lists and to create an unmodifiable version of a list.
 *
...
public final class ListUtils {
  ...
  /**
   * Creates an unmodifiable version of the provided list. If the original list is {@code null} or
   * contains {@code null} elements, this method returns an empty list instead.
   *
   ...
   * @return an unmodifiable copy of the original list if it's non-null and contains no {@code null}
   *     elements; otherwise, returns an immutable empty list
   */
